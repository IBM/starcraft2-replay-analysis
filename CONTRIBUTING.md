...
repository](https://github.com/IBM/starcraft2-replay-analysis).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/starcraft2-replay-analysis/issues). Before embarking on
...
issue](https://github.com/IBM/starcraft2-replay-analysis/issues) before sending a pull
